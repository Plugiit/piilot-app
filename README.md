...
<!-- roadmap:readme -->
**Version actuelle : `0.3.2`** — détail de chaque release dans [ROADMAP.md](ROADMAP.md).
...
| 📍 Actuelle (`0.3.2`) | **0.3.0** | Back-office PM et CRM | Admin | Tickets, livrables, temps, CRM, image unique |
